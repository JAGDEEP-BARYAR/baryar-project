        ...
        <div id="about">
            ...
            <div className="flex flex-row mx-auto max-w-[60%] mt-10 justify-center">
                <p className="w-25vw w-1/2 font-mono text-lg pr-1 text-black-400">
                    I'm an enthusiastic software and web application developer committed to crafting meaningful digital solutions. My expertise lies in coding and inventive problem-solving, allowing me to develop user-centric applications that are both intuitive and effective.
                    Fueled by my passion for innovation and relentless pursuit of knowledge, I excel in team settings where I can bring forth new ideas and collaborate closely to achieve outstanding outcomes. I'm eager to engage with opportunities that enable me to leverage my skills and make a positive impact through technology.
