        ...
        <div id="about">
            ...
            <div className="flex flex-row mx-auto max-w-[60%] mt-10 justify-center">
                <p className="w-25vw w-1/2 font-mono text-lg pr-1 text-black-400">
                    I am an enthusiastic software and web application developer committed to crafting meaningful digital solutions. My expertise lies in coding and inventive problem-solving, allowing me to develop user-centric applications that are both intuitive and effective.
